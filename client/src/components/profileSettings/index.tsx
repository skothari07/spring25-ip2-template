      ...
      <div className='profile-card'>
        ...
        {userData ? (
          <>
              ...
              <p>
                ...
                {canEditProfile && (
                  <button
                    ...
                    onClick={
                      /* DONE: Task 1 - Complete the click handler function to enter the editing mode and 
            ...
            {/* DONE: Task 1 - Conditionally render the below `div` such that it's only displayed when currently
            ...
            {canEditProfile && (
              /* DONE: Task 1 - Conditionally render the component such that it's only displayed 
