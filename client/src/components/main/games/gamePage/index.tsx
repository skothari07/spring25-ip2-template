...
const GamePage = () => {
  ...
  const renderGameComponent = (gameType: string) => {
    // DONE: Task 2 - Implement a switch-case statement to render the appropriate
  ...
  return (
    <div className='game-page'>
      ...
      <div className='game-controls'>
        {/* DONE: Task 2 - Add a button that leaves the game on click.
      ...
      {/* DONE: Task 2 - Conditionally render the correct game component based on the type */}
